...
constexpr auto file_path = "./data/1.txt";
constexpr auto key_path = "./data/key.txt";
constexpr auto file_a = "./data/encrypt_a.txt";
constexpr auto file_b = "./data/encrypt_b.txt";
